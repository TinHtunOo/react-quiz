  ...
  switch (action.type) {
      ...
      return {
        ...
        point:
          action.payload === curQuestion.correctOption
            ? state.point + curQuestion.points
            : state.point,
      };
    case "nextQuestion":
    ...
    case "finishQuiz":
      return {
        ...
        status: "finish",
        highscore:
          state.highscore < state.point ? state.point : state.highscore,
      };
    case "resetQuiz":
      return {
        ...state,
...
function QuizProvider({ children }) {
  const [
    { questions, index, status, answer, highscore, point, timer },
    dispatch,
...
function useQuiz() {
  ...
  if (context === undefined)
    throw new Error("The context is used outside of Provider.");
